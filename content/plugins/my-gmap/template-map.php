...
<div id="menumap"> 
    <ul> 
        <li><a href="?page=my-gmap/my-gmap.php">créer une carte</a></li> 
            ...
            echo "<li ".$active."><a href=\"?page=my-gmap/my-gmap.php&p= 
            map&id=".$getmap->id."\">".$getmap->titre."</a></li>"; 
            }  
            ?> 
    </ul> 
</div>
...
<form action="?page=my-gmap/my-gmap.php&action=deletemap"method="post"> 
    ...
    <p> 
        <input type="submit" class="button button-primary" id="bt-map" value="supprimer la carte" /> 
    </p>  
</form>
